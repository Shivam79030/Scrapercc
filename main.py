...
💡 *Note:* Only authorized users can access the bot. Contact @SANJIT_CHAURASYAmm for authorization.
...
You are not authorized to use this bot. Please contact @SANJIT_CHAURASYA for authorization.
        """
...
💡 *Note:* Only authorized users can access the bot. Contact @SANJIT_CHAURASYA for authorization.
    """
